...
void parse_tree_read_cmd1(char* source, TSNode cmd1, ZAM_instr_t* ptr_instr, int* errno) {
...
void parse_tree_read_block(char *source, TSNode block_node,
                           ZAM_instr_array instr_buffer, location_array locs,
                           int *errno) {
  TSNode instr_node = {};
...
void parse_tree(char *source, TSTree *tree, ZAM_code_t** code, int *errno) {
  TSNode code_node = {};
